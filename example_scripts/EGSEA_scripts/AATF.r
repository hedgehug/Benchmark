...
count_mat <- read.table('../data/count_matrix/AATF.txt',
...
# write results
write.table(gsa$results$custom$test.results$'2vs1'[1:11], '../example_results/EGSEA_results/AATF.egsea_result.txt', quote = FALSE, sep = "\t")
