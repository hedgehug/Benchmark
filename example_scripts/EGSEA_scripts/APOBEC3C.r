...
count_mat <- read.table('../data/count_matrix/APOBEC3C.txt',
...
# write results
write.table(gsa$results$custom$test.results$'2vs1'[1:11], '../example_results/EGSEA_results/APOBEC3C.egsea_result.txt', quote = FALSE, sep = "\t")
