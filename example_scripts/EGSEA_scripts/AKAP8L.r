...
count_mat <- read.table('../data/count_matrix/AKAP8L.txt',
...
# write results
write.table(gsa$results$custom$test.results$'2vs1'[1:11], '../example_results/EGSEA_results/AKAP8L.egsea_result.txt', quote = FALSE, sep = "\t")
