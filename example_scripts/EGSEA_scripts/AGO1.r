...
count_mat <- read.table('../data/count_matrix/AGO1.txt',
...
# write results
write.table(gsa$results$custom$test.results$'2vs1'[1:11], '../example_results/EGSEA_results/AGO1.egsea_result.txt', quote = FALSE, sep = "\t")
