...
count_mat <- read.table('../data/count_matrix/ADAR.txt_data_matrix.txt',
...
# write results
write.table(gsa$results$custom$test.results$'2vs1', '../example_results/globaltest_egsea_results/ADAR.egsea.globaltest.txt', quote = FALSE, sep = "\t")
