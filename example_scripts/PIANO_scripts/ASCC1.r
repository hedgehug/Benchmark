...
pval_table <- read.table('data/prerank_DESeq2/ASCC1.rnk')
...
tval_table <- read.table('data/prerank_fc/ASCC1.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/ASCC1.rank.txt', sep='\t', quote = FALSE)
