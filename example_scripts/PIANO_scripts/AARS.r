...
pval_table <- read.table('data/prerank_DESeq2/AARS.rnk')
...
tval_table <- read.table('data/prerank_fc/AARS.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/AARS.rank.txt', sep='\t', quote = FALSE)
