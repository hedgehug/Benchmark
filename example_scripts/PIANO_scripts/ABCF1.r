...
pval_table <- read.table('data/prerank_DESeq2/ABCF1.rnk')
...
tval_table <- read.table('data/prerank_fc/ABCF1.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/ABCF1.rank.txt', sep='\t', quote = FALSE)
