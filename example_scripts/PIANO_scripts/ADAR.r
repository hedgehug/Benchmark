...
pval_table <- read.table('data/prerank_DESeq2/ADAR.rnk')
...
tval_table <- read.table('data/prerank_fc/ADAR.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/ADAR.rank.txt', sep='\t', quote = FALSE)
