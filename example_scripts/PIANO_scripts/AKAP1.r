...
pval_table <- read.table('data/prerank_DESeq2/AKAP1.rnk')
...
tval_table <- read.table('data/prerank_fc/AKAP1.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/AKAP1.rank.txt', sep='\t', quote = FALSE)
