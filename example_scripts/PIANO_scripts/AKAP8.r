...
pval_table <- read.table('data/prerank_DESeq2/AKAP8.rnk')
...
tval_table <- read.table('data/prerank_fc/AKAP8.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/AKAP8.rank.txt', sep='\t', quote = FALSE)
