...
pval_table <- read.table('data/prerank_DESeq2/AGO1.rnk')
...
tval_table <- read.table('data/prerank_fc/AGO1.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/AGO1.rank.txt', sep='\t', quote = FALSE)
