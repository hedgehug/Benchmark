...
pval_table <- read.table('data/prerank_DESeq2/AATF.rnk')
...
tval_table <- read.table('data/prerank_fc/AATF.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/AATF.rank.txt', sep='\t', quote = FALSE)
