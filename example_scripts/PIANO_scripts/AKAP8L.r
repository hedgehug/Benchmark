...
pval_table <- read.table('data/prerank_DESeq2/AKAP8L.rnk')
...
tval_table <- read.table('data/prerank_fc/AKAP8L.txt')
...
write.table(combres$rankMat, file='example_results/PIANO_results/AKAP8L.rank.txt', sep='\t', quote = FALSE)
