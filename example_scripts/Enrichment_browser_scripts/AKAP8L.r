...
exprs.file<-file.path(data.dir,"AKAP8L.exprs.tab") 
cdat.file<-file.path(data.dir,"AKAP8L.colData.tab") 
rdat.file<-file.path(data.dir,"AKAP8L.rowData.tab") 
...
write.table(res, '../example_results/Enrichment_browser_results/AKAP8L.ebrowser_result.txt', sep = '\t', quote = FALSE)