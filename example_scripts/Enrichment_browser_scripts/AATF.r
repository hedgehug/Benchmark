...
data.dir <- 'DATA_DIR'
exprs.file<-file.path(data.dir,"AATF.exprs.tab") 
cdat.file<-file.path(data.dir,"AATF.colData.tab") 
rdat.file<-file.path(data.dir,"AATF.rowData.tab") 
...
write.table(res, 'example_results/Enrichment_browser_results/AATF.ebrowser_result.txt', sep = '\t', quote = FALSE)
