...
exprs.file<-file.path(data.dir,"ASCC1.exprs.tab") 
cdat.file<-file.path(data.dir,"ASCC1.colData.tab") 
rdat.file<-file.path(data.dir,"ASCC1.rowData.tab") 
...
write.table(res, '../example_results/Enrichment_browser_results/ASCC1.ebrowser_result.txt', sep = '\t', quote = FALSE)