...
data.dir <- 'DATA_DIR'
exprs.file<-file.path(data.dir,"ABCF1.exprs.tab") 
cdat.file<-file.path(data.dir,"ABCF1.colData.tab") 
rdat.file<-file.path(data.dir,"ABCF1.rowData.tab") 
...
write.table(res, 'example_results/Enrichment_browser_results/ABCF1.ebrowser_result.txt', sep = '\t', quote = FALSE)
